...
<div class="card mb-4 shadow">
  <div class="card-body">
    ...
    <div class="alert alert-success mb-3">
      <small><strong>성과:</strong> 무중단 전환 성공 | 배포 시간 83% 단축 | 장애 발생률 100% 감소 | 인프라 비용 35% 절감</small>
    </div>
...
<div class="card mb-4 shadow">
  <div class="card-body">
    ...
    <div class="mb-3">
      <span class="badge bg-info me-1">SwiftUI</span>
      <span class="badge bg-info me-1">iOS</span>
      <span class="badge bg-secondary">CoreData</span>
    </div>
    ...
    <details>
      ...
      <div class="mt-3 ps-3 border-start border-secondary border-3">
        ...
        <a href="https://apps.apple.com/kr/app/나주시-버스/id6459411077" class="btn btn-sm btn-dark mt-3 me-2" target="_blank">
...
<div class="card mb-4 shadow">
  <div class="card-body">
    ...
    <div class="mb-3">
      ...
      <span class="badge bg-secondary">Chrome API</span>
    </div>
