...
<div class="mb-5">
  <p class="lead text-muted">주요 프로젝트 경험과 성과를 소개합니다.</p>
</div>
...
<div class="card mb-5 shadow-lg border-0">
    ...
    <div class="d-flex justify-content-between align-items-center">
      <div class="text-white">
        <h5 class="card-title mb-2 fw-bold">
          <i class="fas fa-cloud me-2"></i>Azure 클라우드 환경전환
        </h5>
        <p class="mb-0 small opacity-90">
          <i class="far fa-calendar me-1"></i>2024.10 ~ 2025.03 | 
          <i class="fas fa-building me-1"></i>KT DS | 
          <i class="fas fa-user-tie me-1"></i>DevOps
        </p>
      </div>
  ...
  <div class="card-body p-4">
    <div class="mb-4">
      <h6 class="text-muted mb-2"><i class="fas fa-info-circle me-2"></i>프로젝트 개요</h6>
      <p class="fs-6 mb-0">KT Cloud에서 Azure AKS 환경으로의 마이그레이션 프로젝트 (대고객 서비스)</p>
    </div>

    <div class="mb-4">
      <h6 class="text-muted mb-3"><i class="fas fa-layer-group me-2"></i>기술 스택</h6>
      <div class="p-3 bg-light rounded-3">
        <span class="badge bg-success me-2 mb-2 px-3 py-2">
          <i class="fas fa-dharmachakra me-1"></i>Kubernetes
        </span>
        <span class="badge bg-success me-2 mb-2 px-3 py-2">
          <i class="fas fa-cloud me-1"></i>AKS
        </span>
      ...
      <div class="row g-3 text-center">
        <div class="col-6 col-md-3">
          <div class="p-3 bg-white rounded">
            <div class="fs-5 fw-bold text-success">무중단</div>
            <small class="text-muted">전환 성공</small>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="p-3 bg-white rounded">
            <div class="fs-5 fw-bold text-success">83%↓</div>
            <small class="text-muted">배포 시간 단축</small>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="p-3 bg-white rounded">
            <div class="fs-5 fw-bold text-success">100%↓</div>
            <small class="text-muted">장애 발생률 감소</small>
          </div>
        </div>
        <div class="col-6 col-md-3">
          <div class="p-3 bg-white rounded">
            <div class="fs-5 fw-bold text-success">35%↓</div>
            <small class="text-muted">인프라 비용 절감</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <details class="border rounded-3 p-3 bg-light">
      <summary class="fw-bold text-primary" style="cursor: pointer; list-style: none;">
        <i class="fas fa-chevron-down me-2"></i>상세 내용 보기
      </summary>
      <div class="mt-4 ps-3 border-start border-info border-4">
        <h6 class="fw-bold"><i class="fas fa-lightbulb me-2 text-warning"></i>프로젝트 배경</h6>
        <p>입사 후 첫 프로젝트로, Docker/Kubernetes 지식이 거의 없는 상태에서 시작했지만
        해당 프로젝트를 진행하며 클라우드 인프라의 전 과정을 경험할 수 있었습니다.</p>
        
        <h6 class="fw-bold mt-4"><i class="fas fa-bullseye me-2 text-danger"></i>핵심 과제</h6>
        ...
        <h6 class="fw-bold mt-4"><i class="fas fa-chart-line me-2 text-success"></i>성과 지표</h6>
    ...
    <div class="mt-4">
      <a href="https://globalshop.kt.com/global/globalMain.do" class="btn btn-primary" target="_blank">
...
<div class="card mb-5 shadow-lg border-0">
  <div class="card-header bg-gradient border-0 py-3" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
    <div class="d-flex justify-content-between align-items-center">
      <div class="text-white">
        ...
        <p class="mb-0 small opacity-90">
          <i class="far fa-calendar me-1"></i>2025.05 ~ 2025.07 | 
          <i class="fas fa-users me-1"></i>사내 교육 MVP (6인) | 
          <i class="fas fa-user-tie me-1"></i>Backend & DevOps
        </p>
      </div>
      <span class="badge bg-white text-dark px-3 py-2 fs-6">
        <i class="fas fa-check-circle me-1"></i>완료
  ...
  <div class="card-body p-4">
    <div class="mb-4">
      <h6 class="text-muted mb-2"><i class="fas fa-info-circle me-2"></i>프로젝트 개요</h6>
      <p class="fs-6 mb-0">다양한 플랫폼의 리뷰를 자동 수집·분석하고, ChatGPT API를 활용한 맞춤형 실행계획을 통해 매장 운영 개선을 지원하는 MSA 기반 웹 서비스</p>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="p-3 bg-light rounded-3">
        ...
        <span class="badge bg-success me-2 mb-2 px-3 py-2">
          <i class="fas fa-stream me-1"></i>Event Hub
        </span>
        <span class="badge bg-info me-2 mb-2 px-3 py-2">
          <i class="fas fa-database me-1"></i>PostgreSQL
        </span>
        <span class="badge bg-danger me-2 mb-2 px-3 py-2">
          <i class="fas fa-memory me-1"></i>Redis
        </span>
      </div>
    </div>
    ...
    <details class="border rounded-3 p-3 bg-light">
      ...
      <div class="mt-4 ps-3 border-start border-primary border-4">
        <h6 class="fw-bold"><i class="fas fa-star me-2 text-warning"></i>주요 기능</h6>
        <ul>
          <li><strong>자동 리뷰 수집:</strong> 데이터 크롤링을 통한 다양한 플랫폼 리뷰 통합 관리</li>
          <li><strong>AI 기반 분석:</strong> ChatGPT API를 활용한 리뷰 감정 분석 및 인사이트 도출</li>
          <li><strong>실행계획 생성:</strong> AI가 추천하는 맞춤형 매장 운영 개선 방안 제공</li>
          <li><strong>MSA 아키텍처:</strong> 마이크로서비스 기반 확장 가능한 시스템 설계</li>
        </ul>
        
        <h6 class="fw-bold mt-4"><i class="fas fa-bullseye me-2 text-danger"></i>기술적 구현</h6>
        ...
        <p><strong>2. CI/CD 파이프라인 구축</strong></p>
        <ul>
        ...
        <div class="alert alert-info border-0 mt-4">
          ...
          <p class="mb-0 mt-2">MSA 및 클라우드 디자인 패턴에 대한 이론 학습 후, 2주간의 Sprint를 통해 실제 MVP로 구현하며 
...
<div class="card mb-5 shadow-lg border-0">
  <div class="card-header bg-gradient border-0 py-3" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
    <div class="d-flex justify-content-between align-items-center">
      <div class="text-white">
        ...
        <p class="mb-0 small opacity-90">
          <i class="far fa-calendar me-1"></i>2024.05 ~ 2024.06 | 
          <i class="fas fa-users me-1"></i>SSAFY (2인) | 
          <i class="fas fa-user-tie me-1"></i>Web
        </p>
      </div>
      <span class="badge bg-white text-dark px-3 py-2 fs-6">
        <i class="fas fa-check-circle me-1"></i>완료
  ...
  <div class="card-body p-4">
    <div class="mb-4">
      <h6 class="text-muted mb-2"><i class="fas fa-info-circle me-2"></i>프로젝트 개요</h6>
      <p class="fs-6 mb-0">사진 기반 여행지 추천 웹 서비스 (프로젝트 종료 후 개인 학습 목적으로 Azure 클라우드 환경에 CI/CD 구축)</p>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="p-3 bg-light rounded-3">
        ...
        <span class="badge bg-primary me-2 mb-2 px-3 py-2">
          <i class="fab fa-vuejs me-1"></i>Vue.js
        </span>
        <span class="badge bg-success me-2 mb-2 px-3 py-2">
          <i class="fab fa-docker me-1"></i>Docker
        </span>
        <span class="badge bg-success me-2 mb-2 px-3 py-2">
          <i class="fas fa-sync-alt me-1"></i>Argo CD
        </span>
        <span class="badge bg-info me-2 mb-2 px-3 py-2">
          <i class="fas fa-database me-1"></i>MySQL
        </span>
    ...
    <details class="border rounded-3 p-3 bg-light">
      ...
      <div class="mt-4 ps-3 border-start border-success border-4">
        <h6 class="fw-bold"><i class="fas fa-lightbulb me-2 text-warning"></i>프로젝트 배경</h6>
        <p>SSAFY 과정 중 2인 팀 프로젝트로 시작했으나, 프로젝트 종료 후 <strong>개인 학습 목적</strong>으로 기존 서비스를 컨테이너화하고 Azure 클라우드 환경에 CI/CD 파이프라인을 구축했습니다.</p>
        
        <h6 class="fw-bold mt-4"><i class="fas fa-bullseye me-2 text-danger"></i>주요 개선사항</h6>
        <p><strong>기존 프로젝트:</strong></p>
        <ul>
...
<div class="card mb-5 shadow-lg border-0">
  <div class="card-header bg-gradient border-0 py-3" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%);">
    <div class="d-flex justify-content-between align-items-center">
      <div class="text-white">
        <h5 class="card-title mb-2 fw-bold">
        ...
        <p class="mb-0 small opacity-90">
          <i class="far fa-calendar me-1"></i>2023.03 ~ 현재 | 
          <i class="fas fa-user me-1"></i>개인 프로젝트 | 
          <i class="fab fa-apple me-1"></i>iOS App
        </p>
      </div>
      <span class="badge bg-white text-success px-3 py-2 fs-6">
        <i class="fas fa-circle me-1" style="animation: pulse 2s infinite;"></i>운영중
      </span>
    </div>
  </div>
  ...
  <div class="card-body p-4">
    <div class="mb-4">
      <h6 class="text-muted mb-2"><i class="fas fa-info-circle me-2"></i>프로젝트 개요</h6>
      <p class="fs-6 mb-0">SwiftUI 기반 iOS 앱 - App Store 정식 배포 | 3년간 안정적 운영 | 서버리스 아키텍처</p>
    </div>
    ...
    <div class="mb-4">
      ...
      <div class="p-3 bg-light rounded-3">
        <span class="badge bg-info me-2 mb-2 px-3 py-2">
          <i class="fab fa-swift me-1"></i>SwiftUI
        </span>
        <span class="badge bg-info me-2 mb-2 px-3 py-2">
          <i class="fab fa-apple me-1"></i>iOS
        </span>
        <span class="badge bg-secondary me-2 mb-2 px-3 py-2">
          <i class="fas fa-database me-1"></i>CoreData
        </span>
      </div>
    </div>
    ...
    <details class="border rounded-3 p-3 bg-light">
      ...
      <div class="mt-4 ps-3 border-start border-secondary border-4">
        <h6 class="fw-bold"><i class="fas fa-lightbulb me-2 text-warning"></i>개발 동기</h6>
        <p>나주시에는 버스 정보를 제공하는 앱이 없어, 공공 API를 활용하여 직접 개발하게 되었습니다.</p>
        
        <h6 class="fw-bold mt-4"><i class="fas fa-bullseye me-2 text-danger"></i>기술적 특징</h6>
        ...
        <div class="alert alert-success border-0 mt-4">
          <strong><i class="fas fa-smile me-2"></i>느낀점</strong>
          <p class="mb-0 mt-2">실제 사용자가 있는 앱을 3년간 운영하면서, 버그 수정, 기능 개선, 
...
<div class="card mb-5 shadow-lg border-0">
  <div class="card-header bg-gradient border-0 py-3" style="background: linear-gradient(135deg, #30cfd0 0%, #330867 100%);">
    <div class="d-flex justify-content-between align-items-center">
      <div class="text-white">
        <h5 class="card-title mb-2 fw-bold">
        ...
        <p class="mb-0 small opacity-90">
          <i class="far fa-calendar me-1"></i>2023.03 ~ 2023.06 | 
          <i class="fas fa-users me-1"></i>교내 오픈소스 프로젝트 (3인)
        </p>
      </div>
      <span class="badge bg-white text-dark px-3 py-2 fs-6">
        <i class="fas fa-check-circle me-1"></i>완료
  ...
  <div class="card-body p-4">
    <div class="mb-4">
      <h6 class="text-muted mb-2"><i class="fas fa-info-circle me-2"></i>프로젝트 개요</h6>
      <p class="fs-6 mb-0">알고리즘 문제풀이 사이트 Chrome Extension에 타이머 기능 추가 (Git Flow, PR, 코드 리뷰 경험)</p>
    </div>
    ...
    <details class="border rounded-3 p-3 bg-light">
      ...
      <div class="mt-4 ps-3 border-start border-dark border-4">
        <h6 class="fw-bold"><i class="fas fa-hands-helping me-2 text-success"></i>기여 내용</h6>
        <p>알고리즘 문제를 풀 때 시간 측정이 필요한 사용자를 위해 <strong>타이머 기능</strong>을 추가하는 오픈소스 기여 프로젝트</p>
        
        <h6 class="fw-bold mt-4"><i class="fas fa-bullseye me-2 text-danger"></i>학습 성과</h6>
        <ul>
