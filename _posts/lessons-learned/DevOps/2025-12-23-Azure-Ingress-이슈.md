...
2025년 10월 4일 오전 10시경에 해외여행 중 웹 사이트 접속 불가 장애가 발생했습니다.

유관부서와 팀원분들이 원인 파악에 나섰고, Ingress의 라우팅 실패로 인한 서비스 장애로 결론 내렸습니다. 결국 Ingress의 특정 어노테이션을 제거함으로써 모든 상황이 해결되었습니다.

이후 왜 이런 서비스의 Silent Failure가 발생했는지 집중적으로 조사하였고, 이 과정에서 얻은 Lesson Learned를 정리해 보겠습니다.
